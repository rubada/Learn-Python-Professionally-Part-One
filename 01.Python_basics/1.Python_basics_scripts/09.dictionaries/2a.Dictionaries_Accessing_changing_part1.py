# Dictionary Accessing, changing, and modifying:
# Dictionary methods will be covered in this video and the upcoming videos
# To check all the methods, check the following site:
# https://docs.python.org/3/library/stdtypes.html#dict
# or any other site you prefer.

# Use the dictionary keys, as mentioned in the previous video to access
# or change the value.
...
# Using get() method, gives the same result
...
# Note that when the dictionary is changed, the list that is created using
# list() will not be modified or changed.
...
# Using membership operators to check if a key in a dictionary:
# if "fruit" in my_dict:
#     print(True)
