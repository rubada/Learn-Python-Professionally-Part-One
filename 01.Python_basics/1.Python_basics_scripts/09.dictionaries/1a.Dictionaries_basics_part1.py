# Dictionaries
# A dictionary is built-in mapping type, used to store a collection of
...
# In the next video we will discuss accessing a dictionary in detail.
...
# a dictionary
# 3. Dictionaries don't allow duplicate keys, having two values with the same
# key name.

# my_dict2 = {1: 2, 2: "red", 4: 2, 2: 4}
# print(my_dict2)

# 4. When defining a key, the key should be an immutable object, and it is
# preferred to use strings
