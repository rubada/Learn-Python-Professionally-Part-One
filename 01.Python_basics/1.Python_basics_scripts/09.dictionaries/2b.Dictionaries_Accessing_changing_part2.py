# Dictionay Accessing
# Accessing the values in the dictonary, by using the values method,
...
# Another way to change or modify a dictinary, use the update() method.
my_dict2 = {"color": "red", "fruit": "banana", "year": 1988,
            "age": 20}
my_dict2.update({"year": 2008, "animal": "cat"})
# print(my_dict2)

# To merge two dictionary together, there are two ways which are introduced
# in Python version 3.9, and all the versions after 3.9 have this method.
