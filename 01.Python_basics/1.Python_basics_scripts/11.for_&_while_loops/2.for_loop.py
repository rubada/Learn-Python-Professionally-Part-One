...
# If output is required then continue statement should be used
# for item in my_list:
#     x += 1
#     if item == "Python":
#         continue
...
# pass statement can be used with for loop in order not to leave
# the loop empty, same as if statement
