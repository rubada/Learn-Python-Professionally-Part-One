...
"""When using the backslash, Python will recognize it as the line
continuation either in string or code line as shown below"""
a = 3 + 2 \
    + 8
# print(a)

"""If the code has (), [], {}, there is a need to use the backslash for line
continuation.
() used in function there is no need to use backslash for line continuation.
The same rule applies in lists [], sets and dictionary {} and tuple()"""
