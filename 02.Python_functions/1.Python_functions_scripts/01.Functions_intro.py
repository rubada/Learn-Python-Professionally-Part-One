...
# in the code, to prevent repeat this task inside the code a function is
...
# An arguments or actual parameters are values that are passed in the function
# parenthesis.
# Let's Take an example tp explain the above.
...
# To call a function, parentthesis should used to get the result.
# fun_func()
